...
import OverView from './tabs/home';  // Your OverView component (for Home tab)
import List from './tabs/list';       // Your List component (for List tab)
import Something from './tabs/something'; // Your Something component (for Something tab)
import Svg, { Path,G,Defs,ClipPath,Rect } from 'react-native-svg';
import All from './tabs/OverView';
...
const screenOptions = {
  ...
  tabBarStyle: {
    ...
    elevation: 0,
    height: 60,
    backgroundColor: '#2a2b37', // Tab bar background
  },
};
...
const Accounts = () => {
  return (
    <Tab.Navigator screenOptions={screenOptions}>
      {/* Home tab - Displays the OverView component when clicked */}
  <Tab.Screen
  name="Arrange"
  component={Arrange}
  options={{
...
/>
        ...
        options={{
          ...
          tabBarIcon: ({ focused, color }) => (
            <Svg width="50" height="50" viewBox="0 0 50 50" fill="none">
              <Path
                d="M36 28V33C36 33.55 35.55 34 35 34H16"
                stroke={focused ? 'orange' : color}
                strokeMiterlimit="10"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <Path
                d="M16 19H35C35.55 19 36 19.45 36 20V24"
                stroke={focused ? 'orange' : color}
                strokeMiterlimit="10"
                strokeLinecap="round"
                strokeLinejoin="round"
              ...
              />
              <Path
                d="M16 15C14.9 15 14 15.9 14 17C14 18.1 14.9 19 16 19"
                stroke={focused ? 'orange' : color}
                strokeMiterlimit="10"
                strokeLinecap="round"
                strokeLinejoin="round"
              ...
              />
              <Path
                d="M33 19V16C33 15.45 32.55 15 32 15H16"
                stroke={focused ? 'orange' : color}
                strokeMiterlimit="10"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <Path
                d="M14 32C14 33.1 14.9 34 16 34"
                stroke={focused ? 'orange' : color}
                strokeMiterlimit="10"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <Path
                d="M30 28C28.9 28 28 27.1 28 26C28 24.9 28.9 24 30 24"
                stroke={focused ? 'orange' : color}
                strokeMiterlimit="10"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <Path
                d="M30 28H36C36.55 28 37 27.55 37 27V25C37 24.45 36.55 24 36 24H30"
                stroke={focused ? 'orange' : color}
                strokeMiterlimit="10"
                strokeLinecap="round"
                strokeLinejoin="round"
      ...
      {/* List tab - Displays the List component when clicked */}
      <Tab.Screen
        name="List"
        component={List}
        options={{
          ...
          tabBarIcon: ({ focused, color }) => (
            <Svg width="50" height="50" viewBox="0 0 50 50" fill="none">
              <Path
                d="M35 33H14C13.45 33 13 32.55 13 32V19C13 18.45 13.45 18 14 18H35C35.55 18 36 18.45 36 19V32C36 32.55 35.55 33 35 33Z"
                stroke={focused ? 'orange' : color}
                strokeMiterlimit="10"
                strokeLinecap="round"
                strokeLinejoin="round"
      ...
      {/* Something tab - Displays the Something component when clicked */}
      <Tab.Screen
  name="Something"
  component={Something}
  options={{
    ...
    tabBarIcon: ({ focused }) => (
      <Svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <G clipPath="url(#clip0_9576_2199)" fill={focused ? 'orange' : 'gray'}>
